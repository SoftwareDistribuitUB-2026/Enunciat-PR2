...
| 6 | 18/05/26 | Desplegament i tasques asíncrones | [Sessió 6](sessions/sessio6.md) | [Tasques Asíncrones i Programades a Django](../guies/tasques_asincrones.md)<br>[Entorns d'Execució: Desenvolupament vs Producció (Docker)](../guies/docker_dev_vs_prod.md)<br>[Docker Desktop a Windows (Aules)](../guies/docker_desktop_windows.md)<br>[Cadenes de Tasques amb Celery i django_q2](../guies/cadenes_tasques_celery_django_q2.md) |
| 7 | 25/05/26 | Proves creuades i informe final | [Sessió 7](sessions/sessio7.md) | [Plantilla de l'informe de proves creuades (Sessió 7)](../guies/plantilla_informe_proves_creuades_sessio7.md)<br>[Catàleg de proves i criteris d'avaluació (Sessió 7)](../guies/proves_i_criteris_sessio7.md)<br>[Entorns d'Execució: Desenvolupament vs Producció (Docker)](../guies/docker_dev_vs_prod.md) |
